...
export default function ApplicationsTable(applications) {
    ...
    if (applications.applications?.length <= 0) {
        return (
            <Paper elevation={0} sx={{mt: 0, borderRadius: 3, height: '150px', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                <Typography fontWeight={'bold'} fontSize={'16pt'}>No applications found.</Typography>
            </Paper>
        )
    } else {
        return (
