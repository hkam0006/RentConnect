import { Button, Card, CardContent, CardHeader, CardMedia, Container, Divider, Grid, IconButton, Stack, TextField, Typography } from '@mui/material';
  ...
  return (
    <Container style={{ marginTop: "64px", padding: "20px" }}>
      <Stack direction={'row'} spacing={2}>
        <TextField placeholder='Search properties...' fullWidth />
